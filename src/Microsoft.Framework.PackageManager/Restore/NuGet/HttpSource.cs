    ...
    internal class HttpSource
    {
            ...
            Action<Stream> ensureValidContents)
        {
                ...
                options: FileOptions.Asynchronous | FileOptions.DeleteOnClose))
            {
                ...
                await ConcurrencyUtilities.ExecuteWithFileLocked(result.CacheFileName, timeoutMilliseconds: 5000, action: async _ =>
                {
        ...
        private async Task<HttpSourceResult> TryCache(string uri, string cacheKey, TimeSpan cacheAgeLimit)
        {
            ...
            return await ConcurrencyUtilities.ExecuteWithFileLocked(cacheFile, timeoutMilliseconds: 5000, action: _ =>
            {
