...
namespace Microsoft.Framework.Runtime.DependencyManagement
{
    public class LockFileFormat
    {
        ...
        private LockFileFrameworkGroup ReadFrameworkGroup(string property, JToken json)
        {
            ...
            group.FrameworkAssemblies = ReadArray(json["frameworkAssemblies"] as JArray, ReadFrameworkAssemblyReference2);
        ...
        private JProperty WriteFrameworkGroup(LockFileFrameworkGroup group)
        {
            ...
            json["frameworkAssemblies"] = WriteArray(group.FrameworkAssemblies, WriteFrameworkAssemblyReference2);
        ...
        private FrameworkAssemblyReference ReadFrameworkAssemblyReference2(JToken json)
        {
            return new FrameworkAssemblyReference(json.Value<string>());
        }

        private JToken WriteFrameworkAssemblyReference2(FrameworkAssemblyReference item)
        {
