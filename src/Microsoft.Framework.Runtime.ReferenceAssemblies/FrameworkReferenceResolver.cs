...
namespace Microsoft.Framework.Runtime
{
    public class FrameworkReferenceResolver : IFrameworkReferenceResolver
    {
        ...
        {
            { new FrameworkName(FrameworkConstants.FrameworkIdentifiers.AspNet, new Version(5, 0)), new List<FrameworkName> {
                    new FrameworkName(FrameworkConstants.FrameworkIdentifiers.Net, new Version(4, 5, 1))
                }
            },
            { new FrameworkName(FrameworkConstants.FrameworkIdentifiers.Dnx, new Version(4, 5, 1)), new List<FrameworkName> {
                    new FrameworkName(FrameworkConstants.FrameworkIdentifiers.Net, new Version(4, 5, 1))
                }
            }
        };
        ...
        {
            { new FrameworkName(FrameworkConstants.FrameworkIdentifiers.Net, new Version(4, 5, 1)), new List<FrameworkName> {
                    new FrameworkName(FrameworkConstants.FrameworkIdentifiers.Dnx, new Version(4, 5, 1)),
                    new FrameworkName(FrameworkConstants.FrameworkIdentifiers.AspNet, new Version(5, 0))
                }
            }
        };
        ...
        public string GetFriendlyFrameworkName(FrameworkName targetFramework)
        {
            ...
            if (string.Equals(targetFramework.Identifier, FrameworkConstants.FrameworkIdentifiers.DnxCore, StringComparison.OrdinalIgnoreCase))
            {
                return "DNX Core 5.0";
            }
            else if (string.Equals(targetFramework.Identifier, FrameworkConstants.FrameworkIdentifiers.Dnx, StringComparison.OrdinalIgnoreCase))
            {
